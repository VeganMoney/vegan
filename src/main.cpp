...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1528226484;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 0 : 897625;
        ...
        assert(block.hashMerkleRoot == uint256("0x89a18fe7e04b1467798b8d2a83b5bb93c06bdac99bb04858a7b52ea72e232c29"));
